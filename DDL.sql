...
CREATE TABLE public.ers_user_roles (
                                       ers_user_role_id serial4 NOT NULL,
...
CREATE TABLE public.ers_reimbursement (
                                          ...
                                          CONSTRAINT ers_reimbursement_fk FOREIGN KEY (reimb_status_id) REFERENCES public.ers_reimbursement_status(reimb_status_id) ON DELETE CASCADE,
                                          CONSTRAINT ers_reimbursement_fk2 FOREIGN KEY (reimb_type_id) REFERENCES public.ers_reimbursement_type(reimb_type_id) ON DELETE CASCADE,
